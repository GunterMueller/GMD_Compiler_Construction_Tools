...
#define yyDStateCount	165
#define yyTableSize	3983
    ...
    for (;;) {
      ...
      for (;;) {
        ...
        case 155:;
          ...
          break;
        case 154:;
          Errors_ErrorMessage((LONGCARD)UnclosedString, (LONGCARD)Errors_Error, Scanner_Attribute.Position);
          Strings_Append(&String, Strings_Char(&String, 1));
          yyEol(0L);
          yyPrevious();
          Strings_Concatenate(&TargetCode, &String);
          ...
          if (yyChBufferIndex != yyChBufferStart + yyBytesRead) {
            ...
            if (Scanner_TokenLength == 0) {
              ...
              if (yyFileStackPtr == 0) {
                ...
                case targetcode:;
                case set:;
                  Errors_ErrorMessage((LONGCARD)BraceMissing, (LONGCARD)Errors_Error, Scanner_Attribute.Position);
                  break;
                case comment:;
                  Errors_ErrorMessage((LONGCARD)UnclosedComment, (LONGCARD)Errors_Error, Scanner_Attribute.Position);
                  break;
                case CStr1:;
                case CStr2:;
                case Str1:;
