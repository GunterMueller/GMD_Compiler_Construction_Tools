  ...
  if (t->U_1.V_1.Kind == Tree_Ag) {
    {
      ...
      IO_WriteS(Tree_f, (STRING)"TYPE yyPtrtTree	= POINTER TO ", 29L);
      Tree_WI(Tree_itTree);
      ...
      IO_WriteNl(Tree_f);
      IO_WriteS(Tree_f, (STRING)"VAR yyLabel	: SHORTCARD;", 24L);
      IO_WriteNl(Tree_f);
      IO_WriteS(Tree_f, (STRING)"VAR yyKind	: SHORTCARD;", 23L);
      IO_WriteNl(Tree_f);
      IO_WriteS(Tree_f, (STRING)"VAR yyc	: CHAR;", 15L);
      IO_WriteNl(Tree_f);
      IO_WriteS(Tree_f, (STRING)"VAR yys	: Strings.tString;", 26L);
      IO_WriteNl(Tree_f);
      IO_WriteNl(Tree_f);
      ...
      if (Sets_IsElement(ORD(';'), &Tree_Options)) {
        IO_WriteS(Tree_f, (STRING)"CONST yyInitTreeStoreSize	= 32;", 31L);
        IO_WriteNl(Tree_f);
        IO_WriteNl(Tree_f);
        IO_WriteS(Tree_f, (STRING)"VAR yyTreeStoreSize	: LONGINT;", 30L);
        IO_WriteNl(Tree_f);
        IO_WriteS(Tree_f, (STRING)"VAR yyTreeStorePtr	: POINTER TO ARRAY [0..50000] OF ", 52L);
        Tree_WI(Tree_itTree);
        IO_WriteS(Tree_f, (STRING)";", 1L);
        IO_WriteNl(Tree_f);
        IO_WriteS(Tree_f, (STRING)"VAR yyLabelCount	: INTEGER;", 27L);
        IO_WriteNl(Tree_f);
        IO_WriteS(Tree_f, (STRING)"VAR yyRecursionLevel	: SHORTINT;", 32L);
        IO_WriteNl(Tree_f);
        IO_WriteNl(Tree_f);
      ...
      if (Sets_IsElement(ORD('w'), &Tree_Options)) {
        IO_WriteS(Tree_f, (STRING)"VAR yyIndentLevel	: SHORTINT;", 29L);
        IO_WriteNl(Tree_f);
        IO_WriteNl(Tree_f);
        IO_WriteS(Tree_f, (STRING)"PROCEDURE Write", 15L);
        Tree_WI(Tree_iModule);
        ...
        IO_WriteS(Tree_f, (STRING)");", 2L);
        IO_WriteNl(Tree_f);
        IO_WriteS(Tree_f, (STRING)" VAR yySaveLevel	: SHORTINT;", 28L);
        IO_WriteNl(Tree_f);
        IO_WriteS(Tree_f, (STRING)" BEGIN", 6L);
        IO_WriteNl(Tree_f);
        IO_WriteS(Tree_f, (STRING)"  yyf := yyyf;", 14L);
        ...
        IO_WriteNl(Tree_f);
        IO_WriteS(Tree_f, (STRING)" BEGIN Layout.WriteSpaces (yyf, yyIndentLevel); yyWriteSelector (yys); END yyIndentSelector;", 92L);
        IO_WriteNl(Tree_f);
        IO_WriteNl(Tree_f);
        ...
        IO_WriteS(Tree_f, (STRING)");", 2L);
        IO_WriteNl(Tree_f);
        IO_WriteS(Tree_f, (STRING)" VAR yyLevel	: SHORTCARD;", 25L);
        IO_WriteNl(Tree_f);
        IO_WriteS(Tree_f, (STRING)" BEGIN", 6L);
        IO_WriteNl(Tree_f);
        ...
        IO_WriteNl(Tree_f);
        IO_WriteS(Tree_f, (STRING)"    Layout.WriteSpaces (yyf, yyIndentLevel - 7);", 48L);
        IO_WriteNl(Tree_f);
      ...
      if (Sets_IsElement(ORD('r'), &Tree_Options)) {
        ...
        IO_WriteNl(Tree_f);
        IO_WriteNl(Tree_f);
        IO_WriteS(Tree_f, (STRING)"VAR yyKindToIdent	: ARRAY [0..", 30L);
        Tree_WN(Tree_ClassCount);
        IO_WriteS(Tree_f, (STRING)"] OF Idents.tIdent;", 19L);
        IO_WriteNl(Tree_f);
        IO_WriteS(Tree_f, (STRING)"VAR yyIsInitialized	: BOOLEAN;", 30L);
        IO_WriteNl(Tree_f);
        IO_WriteNl(Tree_f);
        IO_WriteS(Tree_f, (STRING)"PROCEDURE yyMapToKind (VAR yys: Strings.tString): SHORTCARD;", 60L);
        IO_WriteNl(Tree_f);
        IO_WriteS(Tree_f, (STRING)" VAR yyi	: Idents.tIdent;", 25L);
        IO_WriteNl(Tree_f);
        IO_WriteS(Tree_f, (STRING)" VAR yyk	: SHORTCARD;", 21L);
        IO_WriteNl(Tree_f);
        IO_WriteS(Tree_f, (STRING)" BEGIN", 6L);
        IO_WriteNl(Tree_f);
        ...
        IO_WriteNl(Tree_f);
        IO_WriteS(Tree_f, (STRING)" VAR yys	: Strings.tString;", 27L);
        IO_WriteNl(Tree_f);
        IO_WriteS(Tree_f, (STRING)" BEGIN", 6L);
        IO_WriteNl(Tree_f);
      ...
      IO_WriteS(Tree_f, (STRING)"CONST yyNil	= 374C;", 19L);
      IO_WriteNl(Tree_f);
      IO_WriteS(Tree_f, (STRING)"CONST yyNoLabel	= 375C;", 23L);
      IO_WriteNl(Tree_f);
      IO_WriteS(Tree_f, (STRING)"CONST yyLabelDef	= 376C;", 24L);
      IO_WriteNl(Tree_f);
      IO_WriteS(Tree_f, (STRING)"CONST yyLabelUse	= 377C;", 24L);
      IO_WriteNl(Tree_f);
      IO_WriteNl(Tree_f);
      ...
      if (Sets_IsElement(ORD('g'), &Tree_Options)) {
        ...
        IO_WriteNl(Tree_f);
        IO_WriteS(Tree_f, (STRING)"   | yyNil	: yyt^ := ", 21L);
        Tree_WI(Tree_iNoTree);
        IO_WriteS(Tree_f, (STRING)"; RETURN;", 9L);
        IO_WriteNl(Tree_f);
        IO_WriteS(Tree_f, (STRING)"   | yyLabelUse	: yyGet (yyLabel); yyt^ := yyMapToTree (yyLabel); RETURN;", 73L);
        IO_WriteNl(Tree_f);
        IO_WriteS(Tree_f, (STRING)"   | yyLabelDef	: yyGet (yyLabel);", 34L);
        if (Tree_ClassCount > 251) {
  ...
  if (t->U_1.V_1.Kind == Tree_Class) {
    {
      ...
      if ((Tree_NoCodeClass & W_2->Properties) == 0X0L) {
        ...
        if (((SET_ELEM(Tree_HasChildren) | SET_ELEM(Tree_HasAttributes)) & W_2->Properties) != 0X0L) {
          IO_WriteS(Tree_f, (STRING)" yWriteNode", 11L);
          Tree_WI(W_2->Name);
          IO_WriteS(Tree_f, (STRING)" (yyt);", 7L);
        }
        IO_WriteNl(Tree_f);
  ...
  if (t->U_1.V_1.Kind == Tree_Class) {
    {
      ...
      if ((Tree_NoCodeClass & W_3->Properties) == 0X0L && ((SET_ELEM(Tree_HasChildren) | SET_ELEM(Tree_HasAttributes)) & W_3->Properties) != 0X0L) {
        IO_WriteS(Tree_f, (STRING)"PROCEDURE yWriteNode", 20L);
        Tree_WI(W_3->Name);
        IO_WriteS(Tree_f, (STRING)" (yyt: ", 7L);
        Tree_WI(Tree_itTree);
        IO_WriteS(Tree_f, (STRING)");", 2L);
        ...
        if (W_3->BaseClass->U_1.V_1.Kind == Tree_Class && ((SET_ELEM(Tree_HasChildren) | SET_ELEM(Tree_HasAttributes)) & W_3->BaseClass->U_1.V_5.Class.Properties) != 0X0L) {
          IO_WriteS(Tree_f, (STRING)"  yWriteNode", 12L);
        ...
        IO_WriteS(Tree_f, (STRING)" END yWriteNode", 15L);
        Tree_WI(W_3->Name);
        IO_WriteS(Tree_f, (STRING)";", 1L);
        IO_WriteNl(Tree_f);
        IO_WriteNl(Tree_f);
  ...
  if (t->U_1.V_1.Kind == Tree_Class) {
    {
      ...
      if ((Tree_NoCodeClass & W_8->Properties) == 0X0L) {
        ...
        Tree_WI(W_8->Name);
        IO_WriteS(Tree_f, (STRING)": ", 2L);
        if (((SET_ELEM(Tree_HasChildren) | SET_ELEM(Tree_HasAttributes)) & W_8->Properties) != 0X0L) {
  ...
  if (t->U_1.V_1.Kind == Tree_Class) {
    {
      ...
      if ((Tree_NoCodeClass & W_9->Properties) == 0X0L && ((SET_ELEM(Tree_HasChildren) | SET_ELEM(Tree_HasAttributes)) & W_9->Properties) != 0X0L) {
  ...
  if (t->U_1.V_1.Kind == Tree_Attribute) {
    {
      ...
      if ((Tree_NoCodeAttr & W_11->Properties) == 0X0L) {
  ...
  if (t->U_1.V_1.Kind == Tree_Class) {
    {
      ...
      if ((Tree_NoCodeClass & W_12->Properties) == 0X0L && ((SET_ELEM(Tree_HasChildren) | SET_ELEM(Tree_HasAttributes)) & W_12->Properties) != 0X0L) {
        IO_WriteS(Tree_f, (STRING)"| ", 2L);
        Tree_WI(W_12->Name);
        IO_WriteS(Tree_f, (STRING)":", 1L);
        IO_WriteNl(Tree_f);
  ...
  if (t->U_1.V_1.Kind == Tree_Class) {
    {
      ...
      if ((Tree_NoCodeClass & W_15->Properties) == 0X0L && ((SET_ELEM(Tree_HasChildren) | SET_ELEM(Tree_HasAttributes)) & W_15->Properties) != 0X0L) {
        IO_WriteS(Tree_f, (STRING)"| ", 2L);
        Tree_WI(W_15->Name);
        IO_WriteS(Tree_f, (STRING)":", 1L);
        IO_WriteNl(Tree_f);
  ...
  if (t->U_1.V_1.Kind == Tree_Class) {
    {
      ...
      if ((Tree_NoCodeClass & W_18->Properties) == 0X0L && ((SET_ELEM(Tree_HasChildren) | SET_ELEM(Tree_HasAttributes)) & W_18->Properties) != 0X0L) {
        IO_WriteS(Tree_f, (STRING)"| ", 2L);
        Tree_WI(W_18->Name);
        IO_WriteS(Tree_f, (STRING)":", 1L);
        IO_WriteNl(Tree_f);
