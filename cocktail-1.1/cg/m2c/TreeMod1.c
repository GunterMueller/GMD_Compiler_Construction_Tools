  ...
  if (t->U_1.V_1.Kind == Tree_Ag) {
    {
      ...
      if (!Sets_IsElement(ORD('<'), &Tree_Options)) {
        ...
        IO_WriteS(Tree_f, (STRING)";", 1L);
        IO_WriteNl(Tree_f);
        IO_WriteS(Tree_f, (STRING)"VAR HeapUsed	: LONGCARD;", 24L);
        IO_WriteNl(Tree_f);
        IO_WriteS(Tree_f, (STRING)"VAR yyPoolFreePtr, yyPoolMaxPtr	: SYSTEM.ADDRESS;", 49L);
        IO_WriteNl(Tree_f);
        IO_WriteS(Tree_f, (STRING)"VAR yyNodeSize	: ARRAY [0..", 27L);
        Tree_WN(Tree_ClassCount);
        IO_WriteS(Tree_f, (STRING)"] OF SHORTCARD;", 15L);
        IO_WriteNl(Tree_f);
        IO_WriteS(Tree_f, (STRING)"VAR yyExit	: PROC;", 18L);
        IO_WriteNl(Tree_f);
        IO_WriteNl(Tree_f);
        ...
        Tree_WI(Tree_iMain);
        IO_WriteS(Tree_f, (STRING)"	(Kind: SHORTCARD): ", 20L);
        Tree_WI(Tree_itTree);
        IO_WriteS(Tree_f, (STRING)";", 1L);
        IO_WriteNl(Tree_f);
      ...
      if (Sets_IsElement(ORD('o'), &Tree_Options)) {
        ...
        Tree_WI(Tree_iModule);
        IO_WriteS(Tree_f, (STRING)"Node	(f: IO.tFile; Tree: ", 25L);
        Tree_WI(Tree_itTree);
        IO_WriteS(Tree_f, (STRING)");", 2L);
        IO_WriteNl(Tree_f);
      }
      ...
      if (Sets_IsElement(ORD('t'), &Tree_Options)) {
        ...
        Tree_WI(Tree_iModule);
        IO_WriteS(Tree_f, (STRING)"TD	(Tree: ", 10L);
        Tree_WI(Tree_itTree);
      ...
      if (Sets_IsElement(ORD('b'), &Tree_Options)) {
        IO_WriteS(Tree_f, (STRING)"PROCEDURE Traverse", 18L);
        Tree_WI(Tree_iModule);
        IO_WriteS(Tree_f, (STRING)"BU	(Tree: ", 10L);
        Tree_WI(Tree_itTree);
        IO_WriteS(Tree_f, (STRING)"; Proc: tProcTree);", 19L);
        IO_WriteNl(Tree_f);
      }
...
# endif
{
  ...
  if (t->U_1.V_1.Kind == Tree_Ag) {
    {
      register Tree_yAg *W_11 = &t->U_1.V_26.Ag;

      IO_WriteS(Tree_f, (STRING)"IMPLEMENTATION MODULE ", 22L);
      Tree_WI(Tree_iModule);
      IO_WriteS(Tree_f, (STRING)";", 1L);
      IO_WriteNl(Tree_f);
      IO_WriteS(Tree_f, (STRING)"# define yyALLOC(ptr, size)	ptr := yyPoolFreePtr; \\", 51L);
      IO_WriteNl(Tree_f);
      IO_WriteS(Tree_f, (STRING)"  IF SYSTEM.ADDRESS (ptr) >= yyPoolMaxPtr THEN ptr := yyAlloc (); END; \\", 72L);
      IO_WriteNl(Tree_f);
      IO_WriteS(Tree_f, (STRING)"  INC (yyPoolFreePtr, size);", 28L);
      IO_WriteNl(Tree_f);
      IO_WriteS(Tree_f, (STRING)"# define yyFREE(ptr, size)	", 27L);
      IO_WriteNl(Tree_f);
      IO_WriteNl(Tree_f);
      ...
      if (Sets_IsElement(ORD('<'), &Tree_Options)) {
        ...
        IO_WriteNl(Tree_f);
        Tree_ForallClasses(W_11->Classes, (Tree_ProcOfT)ImportConst);
        IO_WriteS(Tree_f, (STRING)"yyAlloc, yyPoolFreePtr, yyPoolMaxPtr, yyNodeSize;", 49L);
        IO_WriteNl(Tree_f);
        IO_WriteNl(Tree_f);
      }
      TreeMod2_WriteLine(W_11->TreeCodes->U_1.V_12.Codes.GlobalLine);
      Texts_WriteText(Tree_f, W_11->TreeCodes->U_1.V_12.Codes.Global);
      Node = W_11->Modules;
      while (Node->U_1.V_1.Kind == Tree_Module) {
      ...
      TreeMod2_WriteLine(W_11->TreeCodes->U_1.V_12.Codes.LocalLine);
      Texts_WriteText(Tree_f, W_11->TreeCodes->U_1.V_12.Codes.Local);
      Node = W_11->Modules;
      while (Node->U_1.V_1.Kind == Tree_Module) {
      ...
      if (!Sets_IsElement(ORD('<'), &Tree_Options)) {
        ...
        IO_WriteS(Tree_f, (STRING)"TYPE", 4L);
        IO_WriteNl(Tree_f);
        IO_WriteS(Tree_f, (STRING)" yytBlockPtr	= POINTER TO yytBlock;", 35L);
        IO_WriteNl(Tree_f);
        IO_WriteS(Tree_f, (STRING)" yytBlock	= RECORD", 18L);
        IO_WriteNl(Tree_f);
        IO_WriteS(Tree_f, (STRING)"		     yyBlock	: ARRAY [1..yyBlockSize] OF CHAR;", 48L);
        IO_WriteNl(Tree_f);
        IO_WriteS(Tree_f, (STRING)"		     yySuccessor: yytBlockPtr;", 32L);
        IO_WriteNl(Tree_f);
        IO_WriteS(Tree_f, (STRING)"		  END;", 8L);
        IO_WriteNl(Tree_f);
        IO_WriteNl(Tree_f);
        IO_WriteS(Tree_f, (STRING)"VAR yyBlockList	: yytBlockPtr;", 30L);
        IO_WriteNl(Tree_f);
        IO_WriteS(Tree_f, (STRING)"VAR yyMaxSize, yyi	: SHORTCARD;", 31L);
        IO_WriteNl(Tree_f);
        IO_WriteS(Tree_f, (STRING)"VAR yyTypeRange	: ARRAY [0..", 28L);
        Tree_WN(Tree_ClassCount);
        IO_WriteS(Tree_f, (STRING)"] OF SHORTCARD;", 15L);
        IO_WriteNl(Tree_f);
        IO_WriteNl(Tree_f);
        ...
        IO_WriteS(Tree_f, (STRING)";", 1L);
        IO_WriteNl(Tree_f);
        IO_WriteS(Tree_f, (STRING)" VAR yyBlockPtr	: yytBlockPtr;", 30L);
        IO_WriteNl(Tree_f);
        IO_WriteS(Tree_f, (STRING)" BEGIN", 6L);
        IO_WriteNl(Tree_f);
        IO_WriteS(Tree_f, (STRING)"  yyBlockPtr	:= yyBlockList;", 28L);
        IO_WriteNl(Tree_f);
        IO_WriteS(Tree_f, (STRING)"  yyBlockList	:= Memory.Alloc (SYSTEM.TSIZE (yytBlock));", 56L);
        IO_WriteNl(Tree_f);
        IO_WriteS(Tree_f, (STRING)"  yyBlockList^.yySuccessor := yyBlockPtr;", 41L);
        IO_WriteNl(Tree_f);
        IO_WriteS(Tree_f, (STRING)"  yyPoolFreePtr	:= SYSTEM.ADR (yyBlockList^.yyBlock);", 53L);
        IO_WriteNl(Tree_f);
        ...
        IO_WriteS(Tree_f, (STRING)";", 1L);
        IO_WriteNl(Tree_f);
        IO_WriteS(Tree_f, (STRING)" VAR yyByteCount	: LONGINT;", 27L);
        IO_WriteNl(Tree_f);
      ...
      if (Sets_IsElement(ORD('n'), &Tree_Options)) {
        Tree_ForallClasses(W_11->Classes, (Tree_ProcOfT)ProcedureBodyn);
      }
      IO_WriteNl(Tree_f);
      if (Sets_IsElement(ORD('m'), &Tree_Options)) {
        Tree_ForallClasses(W_11->Classes, (Tree_ProcOfT)ProcedureBodym);
      }
      TreeMod2_TreeIO(t);
      if (Sets_IsElement(ORD('f'), &Tree_Options)) {
        IO_WriteS(Tree_f, (STRING)"PROCEDURE Release", 17L);
        ...
        IO_WriteNl(Tree_f);
        IO_WriteNl(Tree_f);
        IO_WriteS(Tree_f, (STRING)"VAR yyChild	: ", 14L);
        Tree_WI(Tree_itTree);
        IO_WriteS(Tree_f, (STRING)";", 1L);
        IO_WriteNl(Tree_f);
        IO_WriteNl(Tree_f);
        ...
        IO_WriteNl(Tree_f);
        Tree_ForallClasses(W_11->Classes, (Tree_ProcOfT)ReleaseAttributes1);
        ...
        IO_WriteNl(Tree_f);
        Tree_ForallClasses(W_11->Classes, (Tree_ProcOfT)ReleaseAttributes2);
      ...
      if (Sets_IsElement(ORD('F'), &Tree_Options) && !Sets_IsElement(ORD('<'), &Tree_Options)) {
        ...
        IO_WriteNl(Tree_f);
        IO_WriteS(Tree_f, (STRING)"   yyBlockPtr	:= yyBlockList;", 29L);
        IO_WriteNl(Tree_f);
        ...
        IO_WriteS(Tree_f, (STRING)"  END;", 6L);
        IO_WriteNl(Tree_f);
        IO_WriteS(Tree_f, (STRING)"  yyPoolFreePtr	:= NIL;", 23L);
        IO_WriteNl(Tree_f);
        IO_WriteS(Tree_f, (STRING)"  yyPoolMaxPtr	:= NIL;", 22L);
        IO_WriteNl(Tree_f);
        IO_WriteS(Tree_f, (STRING)"  HeapUsed	:= 0;", 16L);
        IO_WriteNl(Tree_f);
        IO_WriteS(Tree_f, (STRING)" END Release", 12L);
        Tree_WI(Tree_iModule);
        IO_WriteS(Tree_f, (STRING)"Module;", 7L);
      ...
      if (Sets_IsElement(ORD('t'), &Tree_Options) || Sets_IsElement(ORD('b'), &Tree_Options)) {
        IO_WriteS(Tree_f, (STRING)"VAR yyProc	: tProcTree;", 23L);
        IO_WriteNl(Tree_f);
        IO_WriteNl(Tree_f);
      }
      if (Sets_IsElement(ORD('t'), &Tree_Options)) {
        ...
        IO_WriteS(Tree_f, (STRING)"   CASE yyt^.Kind OF", 20L);
        IO_WriteNl(Tree_f);
        Tree_ForallClasses(W_11->Classes, (Tree_ProcOfT)TraverseTD);
      ...
      if (Sets_IsElement(ORD('b'), &Tree_Options)) {
        ...
        IO_WriteS(Tree_f, (STRING)"  CASE yyt^.Kind OF", 19L);
        IO_WriteNl(Tree_f);
        Tree_ForallClasses(W_11->Classes, (Tree_ProcOfT)TraverseBU);
        IO_WriteS(Tree_f, (STRING)"  ELSE", 6L);
        IO_WriteNl(Tree_f);
        IO_WriteS(Tree_f, (STRING)"  END;", 6L);
        IO_WriteNl(Tree_f);
      ...
      if (Sets_IsElement(ORD('R'), &Tree_Options)) {
        ...
        IO_WriteS(Tree_f, (STRING)";", 1L);
        IO_WriteNl(Tree_f);
        IO_WriteS(Tree_f, (STRING)" VAR yyNew, yyNext, yyTail	: ", 29L);
        Tree_WI(Tree_itTree);
        IO_WriteS(Tree_f, (STRING)";", 1L);
        IO_WriteNl(Tree_f);
        IO_WriteS(Tree_f, (STRING)" BEGIN", 6L);
        IO_WriteNl(Tree_f);
        IO_WriteS(Tree_f, (STRING)"  yyNew	:= yyOld;", 17L);
        IO_WriteNl(Tree_f);
        IO_WriteS(Tree_f, (STRING)"  yyTail	:= yyOld;", 18L);
        IO_WriteNl(Tree_f);
        IO_WriteS(Tree_f, (STRING)"  LOOP", 6L);
        IO_WriteNl(Tree_f);
        IO_WriteS(Tree_f, (STRING)"   CASE yyOld^.Kind OF", 22L);
        IO_WriteNl(Tree_f);
        Tree_ForallClasses(W_11->Classes, (Tree_ProcOfT)Reverse1);
        IO_WriteS(Tree_f, (STRING)"   ELSE EXIT;", 13L);
        IO_WriteNl(Tree_f);
        IO_WriteS(Tree_f, (STRING)"   END;", 7L);
        IO_WriteNl(Tree_f);
        IO_WriteS(Tree_f, (STRING)"   yyNew	:= yyOld;", 18L);
        IO_WriteNl(Tree_f);
        IO_WriteS(Tree_f, (STRING)"   yyOld	:= yyNext;", 19L);
        IO_WriteNl(Tree_f);
        IO_WriteS(Tree_f, (STRING)"  END;", 6L);
        IO_WriteNl(Tree_f);
        IO_WriteS(Tree_f, (STRING)"  CASE yyTail^.Kind OF", 22L);
        IO_WriteNl(Tree_f);
        Tree_ForallClasses(W_11->Classes, (Tree_ProcOfT)Reverse2);
        IO_WriteS(Tree_f, (STRING)"  ELSE", 6L);
        IO_WriteNl(Tree_f);
        IO_WriteS(Tree_f, (STRING)"  END;", 6L);
        IO_WriteNl(Tree_f);
      ...
      if (Sets_IsElement(ORD('y'), &Tree_Options)) {
        IO_WriteS(Tree_f, (STRING)"CONST yyInitOldToNewStoreSize	= 32;", 35L);
        IO_WriteNl(Tree_f);
        IO_WriteNl(Tree_f);
        ...
        IO_WriteNl(Tree_f);
        IO_WriteNl(Tree_f);
        IO_WriteS(Tree_f, (STRING)"VAR yyOldToNewStoreSize	: LONGINT;", 34L);
        IO_WriteNl(Tree_f);
        IO_WriteS(Tree_f, (STRING)"VAR yyOldToNewStorePtr	: POINTER TO ARRAY [0..50000] OF yytOldToNew;", 68L);
        IO_WriteNl(Tree_f);
        IO_WriteS(Tree_f, (STRING)"VAR yyOldToNewCount	: INTEGER;", 30L);
        IO_WriteNl(Tree_f);
        IO_WriteNl(Tree_f);
        ...
        IO_WriteS(Tree_f, (STRING)" BEGIN", 6L);
        IO_WriteNl(Tree_f);
        IO_WriteS(Tree_f, (STRING)"  FOR yyi := 1 TO yyOldToNewCount DO", 36L);
        IO_WriteNl(Tree_f);
        ...
        IO_WriteS(Tree_f, (STRING)"   CASE yyt^.Kind OF", 20L);
        IO_WriteNl(Tree_f);
        Tree_ForallClasses(W_11->Classes, (Tree_ProcOfT)Copy);
        IO_WriteS(Tree_f, (STRING)"   ELSE", 7L);
        IO_WriteNl(Tree_f);
        IO_WriteS(Tree_f, (STRING)"   END;", 7L);
        IO_WriteNl(Tree_f);
        ...
        IO_WriteS(Tree_f, (STRING)";", 1L);
        IO_WriteNl(Tree_f);
        IO_WriteS(Tree_f, (STRING)" VAR yyNew	: ", 13L);
        Tree_WI(Tree_itTree);
        IO_WriteS(Tree_f, (STRING)";", 1L);
        IO_WriteNl(Tree_f);
        IO_WriteS(Tree_f, (STRING)" BEGIN", 6L);
      ...
      if (Sets_IsElement(ORD('k'), &Tree_Options)) {
        ...
        IO_WriteNl(Tree_f);
        IO_WriteS(Tree_f, (STRING)" CONST yyf	= IO.StdError;", 25L);
        IO_WriteNl(Tree_f);
        ...
        IO_WriteS(Tree_f, (STRING)"): BOOLEAN;", 11L);
        IO_WriteNl(Tree_f);
        IO_WriteS(Tree_f, (STRING)" VAR yyResult	: BOOLEAN;", 24L);
        IO_WriteNl(Tree_f);
        IO_WriteS(Tree_f, (STRING)" BEGIN", 6L);
        IO_WriteNl(Tree_f);
        IO_WriteS(Tree_f, (STRING)"  IF yyt = ", 11L);
        ...
        IO_WriteS(Tree_f, (STRING)"  CASE yyt^.Kind OF", 19L);
        IO_WriteNl(Tree_f);
        Tree_ForallClasses(W_11->Classes, (Tree_ProcOfT)CheckAttributes);
        IO_WriteS(Tree_f, (STRING)"  ELSE", 6L);
        IO_WriteNl(Tree_f);
        IO_WriteS(Tree_f, (STRING)"  END;", 6L);
        IO_WriteNl(Tree_f);
      ...
      if (Sets_IsElement(ORD('q'), &Tree_Options)) {
        ...
        IO_WriteNl(Tree_f);
        IO_WriteNl(Tree_f);
        IO_WriteS(Tree_f, (STRING)"VAR yyString	: ARRAY [0..31] OF CHAR;", 37L);
        IO_WriteNl(Tree_f);
        IO_WriteS(Tree_f, (STRING)"VAR yyLength	: INTEGER;", 23L);
        IO_WriteNl(Tree_f);
        IO_WriteS(Tree_f, (STRING)"VAR yyCh	: CHAR;", 16L);
        IO_WriteNl(Tree_f);
        IO_WriteS(Tree_f, (STRING)"VAR yyState	: INTEGER;", 22L);
        IO_WriteNl(Tree_f);
        IO_WriteNl(Tree_f);
        ...
        IO_WriteNl(Tree_f);
        IO_WriteS(Tree_f, (STRING)"   | yyyQuit	: RETURN;", 22L);
        IO_WriteNl(Tree_f);
        IO_WriteS(Tree_f, (STRING)"   | yyyWrite	: Write", 21L);
        Tree_WI(Tree_iModule);
        IO_WriteS(Tree_f, (STRING)"Node (IO.StdOutput, yyt); yyState := yyyRead;", 45L);
        IO_WriteNl(Tree_f);
        IO_WriteS(Tree_f, (STRING)"   | yyyRead	: IO.WriteS (IO.StdOutput, '? '); yyLength := -1; yyCh := IO.ReadC (IO.StdInput);", 94L);
        IO_WriteNl(Tree_f);
        ...
        IO_WriteNl(Tree_f);
        Tree_ForallClasses(W_11->Classes, (Tree_ProcOfT)QueryAttributes);
      ...
      if (Sets_IsElement(ORD('='), &Tree_Options)) {
        ...
        IO_WriteNl(Tree_f);
        Tree_ForallClasses(W_11->Classes, (Tree_ProcOfT)IsEqualAttributes);
      ...
      if (Sets_IsElement(ORD('L'), &Tree_Options)) {
        MaxBit = 0;
        Tree_ForallClasses(W_11->Classes, (Tree_ProcOfT)CompMaxBit);
        IO_WriteS(Tree_f, (STRING)"PROCEDURE Init", 14L);
        Tree_WI(Tree_iModule);
        IO_WriteS(Tree_f, (STRING)" (yyt: ", 7L);
        Tree_WI(Tree_itTree);
        ...
        IO_WriteS(Tree_f, (STRING)"   CASE yyt^.Kind OF", 20L);
        IO_WriteNl(Tree_f);
        Tree_ForallClasses(W_11->Classes, (Tree_ProcOfT)InitAttributes);
        IO_WriteS(Tree_f, (STRING)"   ELSE RETURN;", 15L);
        IO_WriteNl(Tree_f);
        IO_WriteS(Tree_f, (STRING)"   END;", 7L);
        IO_WriteNl(Tree_f);
      ...
      IO_WriteS(Tree_f, (STRING)" BEGIN", 6L);
      IO_WriteNl(Tree_f);
      TreeMod2_WriteLine(W_11->TreeCodes->U_1.V_12.Codes.BeginLine);
      Texts_WriteText(Tree_f, W_11->TreeCodes->U_1.V_12.Codes.Begin);
      Node = W_11->Modules;
      while (Node->U_1.V_1.Kind == Tree_Module) {
      ...
      IO_WriteS(Tree_f, (STRING)" BEGIN", 6L);
      IO_WriteNl(Tree_f);
      TreeMod2_WriteLine(W_11->TreeCodes->U_1.V_12.Codes.CloseLine);
      Texts_WriteText(Tree_f, W_11->TreeCodes->U_1.V_12.Codes.Close);
      Node = W_11->Modules;
      while (Node->U_1.V_1.Kind == Tree_Module) {
      ...
      if (!Sets_IsElement(ORD('<'), &Tree_Options)) {
        IO_WriteS(Tree_f, (STRING)" yyBlockList	:= NIL;", 20L);
        IO_WriteNl(Tree_f);
        IO_WriteS(Tree_f, (STRING)" yyPoolFreePtr	:= NIL;", 22L);
        IO_WriteNl(Tree_f);
        IO_WriteS(Tree_f, (STRING)" yyPoolMaxPtr	:= NIL;", 21L);
        IO_WriteNl(Tree_f);
        IO_WriteS(Tree_f, (STRING)" HeapUsed	:= 0;", 15L);
        IO_WriteNl(Tree_f);
        IO_WriteS(Tree_f, (STRING)" yyExit	:= xxExit;", 18L);
        IO_WriteNl(Tree_f);
        Tree_ForallClasses(W_11->Classes, (Tree_ProcOfT)InitNodeSize);
        IO_WriteS(Tree_f, (STRING)" yyMaxSize	:= 0;", 16L);
        IO_WriteNl(Tree_f);
        ...
        IO_WriteNl(Tree_f);
        Tree_ForallClasses(W_11->Classes, (Tree_ProcOfT)InitTypeRange);
      }
      if (Sets_IsElement(ORD(';'), &Tree_Options)) {
...
# endif
{
  ...
  if (t->U_1.V_1.Kind == Tree_Attribute) {
    {
      register Tree_yAttribute *W_14 = &t->U_1.V_10.Attribute;

      if ((Tree_NoCodeAttr & W_14->Properties) == 0X0L) {
        IO_WriteS(Tree_f, (STRING)"  begin", 7L);
        Tree_WI(W_14->Type);
        IO_WriteS(Tree_f, (STRING)"(yyt^.", 6L);
        Tree_WI(iClassName);
  ...
  if (t->U_1.V_1.Kind == Tree_Child) {
    {
      ...
      if (IN(Tree_Input, W_16->Properties)) {
        IO_WriteS(Tree_f, (STRING)"   ", 3L);
        Tree_WI(W_16->Name);
  ...
  if (t->U_1.V_1.Kind == Tree_Attribute) {
    {
      ...
      if ((Tree_NoCodeAttr & W_17->Properties) == 0X0L) {
        if (IN(Tree_Input, W_17->Properties)) {
          IO_WriteS(Tree_f, (STRING)"   ", 3L);
          Tree_WI(W_17->Name);
          IO_WriteS(Tree_f, (STRING)" := p", 5L);
          Tree_WI(W_17->Name);
  ...
  if (t->U_1.V_1.Kind == Tree_Class) {
    {
      ...
      if ((Tree_NoCodeClass & W_18->Properties) == 0X0L && IN(Tree_HasChildren, W_18->Properties)) {
        IO_WriteS(Tree_f, (STRING)"| ", 2L);
        Tree_WI(W_18->Name);
        IO_WriteS(Tree_f, (STRING)":", 1L);
        IO_WriteNl(Tree_f);
  ...
  if (t->U_1.V_1.Kind == Tree_Class) {
    {
      ...
      if ((Tree_NoCodeClass & W_20->Properties) == 0X0L && IN(Tree_HasAttributes, W_20->Properties)) {
        IO_WriteS(Tree_f, (STRING)"| ", 2L);
        Tree_WI(W_20->Name);
        IO_WriteS(Tree_f, (STRING)":", 1L);
        IO_WriteNl(Tree_f);
  ...
  if (t->U_1.V_1.Kind == Tree_Class) {
    {
      ...
      if ((Tree_NoCodeClass & W_22->Properties) == 0X0L && IN(Tree_HasChildren, W_22->Properties)) {
        IO_WriteS(Tree_f, (STRING)"| ", 2L);
        Tree_WI(W_22->Name);
        IO_WriteS(Tree_f, (STRING)":", 1L);
        IO_WriteNl(Tree_f);
  ...
  if (t->U_1.V_1.Kind == Tree_Child) {
    {
      ...
      if (IN(Tree_Reverse, W_27->Properties)) {
        IO_WriteS(Tree_f, (STRING)"| ", 2L);
        Tree_WI(iClassName);
  ...
  if (t->U_1.V_1.Kind == Tree_Attribute) {
    {
      ...
      if ((Tree_NoCodeAttr & W_32->Properties) == 0X0L) {
        IO_WriteS(Tree_f, (STRING)"copy", 4L);
        Tree_WI(W_32->Type);
        IO_WriteS(Tree_f, (STRING)" (yyNew^^.", 10L);
        Tree_WI(iClassName);
  ...
  if (t->U_1.V_1.Kind == Tree_Class) {
    {
      ...
      if ((Tree_NoCodeClass & W_33->Properties) == 0X0L && IN(Tree_HasChildren, W_33->Properties)) {
        IO_WriteS(Tree_f, (STRING)"| ", 2L);
        Tree_WI(W_33->Name);
        IO_WriteS(Tree_f, (STRING)":", 1L);
        IO_WriteNl(Tree_f);
  ...
  if (t->U_1.V_1.Kind == Tree_Class) {
    {
      ...
      if ((Tree_NoCodeClass & W_35->Properties) == 0X0L) {
        iRange = W_35->Name;
        Tree_ForallClasses(W_35->Extensions, (Tree_ProcOfT)InitTypeRange2);
...
# endif
{
  ...
  if (t->U_1.V_1.Kind == Tree_Class) {
    {
      ...
      if ((Tree_NoCodeClass & W_37->Properties) == 0X0L && IN(Tree_HasChildren, W_37->Properties)) {
        IO_WriteS(Tree_f, (STRING)"| ", 2L);
        Tree_WI(W_37->Name);
        IO_WriteS(Tree_f, (STRING)": IF FALSE THEN", 15L);
        IO_WriteNl(Tree_f);
        iClassName = W_37->Name;
  ...
  if (t->U_1.V_1.Kind == Tree_Child) {
    {
      register Tree_yChild *W_38 = &t->U_1.V_9.Child;
    ...
    for (;;) {
      {
        ...
        if (!((Tree_NoCodeClass & W_44->Properties) == 0X0L)) {
          goto EXIT_3;
        }
...
# endif
{
  ...
  if (t->U_1.V_1.Kind == Tree_Ag) {
    {
      register Tree_yAg *W_45 = &t->U_1.V_26.Ag;
      ...
      Tree_ForallClasses(W_45->Classes, (Tree_ProcOfT)TreeMod1_ImportList);
      if (Sets_IsElement(ORD('f'), &Tree_Options)) {
  ...
  if (t->U_1.V_1.Kind == Tree_Class) {
    {
      ...
      if ((Tree_NoCodeClass & W_47->Properties) == 0X0L) {
        Tree_WI(W_47->Name);
        IO_WriteS(Tree_f, (STRING)", ", 2L);
        IO_WriteNl(Tree_f);
      }
    ...
    for (;;) {
      {
        ...
        if (!(((SET_ELEM(Tree_Input) | SET_ELEM(Tree_Test) | SET_ELEM(Tree_Dummy)) & W_50->Properties) == 0X0L)) {
          goto EXIT_5;
        }
        INC(i);
        return;
