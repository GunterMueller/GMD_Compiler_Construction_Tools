  ...
  if (t->U_1.V_1.Kind == Tree_Ag) {
    {
      ...
      IO_WriteS(Tree_f, (STRING)".h\"", 3L);
      IO_WriteNl(Tree_f);
      IO_WriteS(Tree_f, (STRING)"# define yyALLOC(ptr, size)	if ((ptr = (", 40L);
      Tree_WI(Tree_itTree);
      IO_WriteS(Tree_f, (STRING)") ", 2L);
      Tree_WI(Tree_iMain);
      ...
      Tree_WI(Tree_iMain);
      IO_WriteS(Tree_f, (STRING)"_Alloc (); \\", 12L);
      IO_WriteNl(Tree_f);
      IO_WriteS(Tree_f, (STRING)"  ", 2L);
      Tree_WI(Tree_iMain);
      ...
      if (!Sets_IsElement(ORD('<'), &Tree_Options)) {
        ...
        IO_WriteS(Tree_f, (STRING)";", 1L);
        IO_WriteNl(Tree_f);
        IO_WriteS(Tree_f, (STRING)"static unsigned short yyMaxSize	= 0;", 36L);
        IO_WriteNl(Tree_f);
      ...
      if (Sets_IsElement(ORD('R'), &Tree_Options)) {
        ...
        IO_WriteNl(Tree_f);
        Tree_ForallClasses(W_16->Classes, (Tree_ProcOfT)Reverse1);
        ...
        IO_WriteNl(Tree_f);
        Tree_ForallClasses(W_16->Classes, (Tree_ProcOfT)Reverse2);
        IO_WriteS(Tree_f, (STRING)" default: ;", 11L);
        IO_WriteNl(Tree_f);
        IO_WriteS(Tree_f, (STRING)" }", 2L);
        IO_WriteNl(Tree_f);
      ...
      if (Sets_IsElement(ORD('y'), &Tree_Options)) {
        ...
        IO_WriteS(Tree_f, (STRING)"  switch (yyt->Kind) {", 22L);
        IO_WriteNl(Tree_f);
        Tree_ForallClasses(W_16->Classes, (Tree_ProcOfT)Copy);
        IO_WriteS(Tree_f, (STRING)"  default: ;", 12L);
        IO_WriteNl(Tree_f);
        IO_WriteS(Tree_f, (STRING)"  }", 3L);
        IO_WriteNl(Tree_f);
      ...
      if (Sets_IsElement(ORD('k'), &Tree_Options)) {
        ...
        IO_WriteS(Tree_f, (STRING)" switch (yyt->Kind) {", 21L);
        IO_WriteNl(Tree_f);
        Tree_ForallClasses(W_16->Classes, (Tree_ProcOfT)CheckAttributes);
        IO_WriteS(Tree_f, (STRING)" default: ;", 11L);
        IO_WriteNl(Tree_f);
        IO_WriteS(Tree_f, (STRING)" }", 2L);
        IO_WriteNl(Tree_f);
      ...
      if (Sets_IsElement(ORD('q'), &Tree_Options)) {
        IO_WriteS(Tree_f, (STRING)"# define yyyWrite	1", 19L);
        IO_WriteNl(Tree_f);
        IO_WriteS(Tree_f, (STRING)"# define yyyRead	2", 18L);
        IO_WriteNl(Tree_f);
        IO_WriteS(Tree_f, (STRING)"# define yyyQuit	3", 18L);
        IO_WriteNl(Tree_f);
        IO_WriteNl(Tree_f);
        ...
        IO_WriteNl(Tree_f);
        Tree_ForallClasses(W_16->Classes, (Tree_ProcOfT)QueryAttributes);
      ...
      if (Sets_IsElement(ORD('='), &Tree_Options)) {
        ...
        IO_WriteNl(Tree_f);
        Tree_ForallClasses(W_16->Classes, (Tree_ProcOfT)IsEqualAttributes);
      ...
      if (Sets_IsElement(ORD('L'), &Tree_Options)) {
        MaxBit = 0;
        Tree_ForallClasses(W_16->Classes, (Tree_ProcOfT)CompMaxBit);
        ...
        IO_WriteS(Tree_f, (STRING)"  switch (yyt->Kind) {", 22L);
        IO_WriteNl(Tree_f);
        Tree_ForallClasses(W_16->Classes, (Tree_ProcOfT)InitAttributes);
        IO_WriteS(Tree_f, (STRING)"  default: return;", 18L);
        IO_WriteNl(Tree_f);
        IO_WriteS(Tree_f, (STRING)"  }", 3L);
        IO_WriteNl(Tree_f);
      ...
      IO_WriteS(Tree_f, (STRING)"{", 1L);
      IO_WriteNl(Tree_f);
      TreeC2_WriteLine(W_16->TreeCodes->U_1.V_12.Codes.BeginLine);
      Texts_WriteText(Tree_f, W_16->TreeCodes->U_1.V_12.Codes.Begin);
      Node = W_16->Modules;
      while (Node->U_1.V_1.Kind == Tree_Module) {
      ...
      IO_WriteS(Tree_f, (STRING)"{", 1L);
      IO_WriteNl(Tree_f);
      TreeC2_WriteLine(W_16->TreeCodes->U_1.V_12.Codes.CloseLine);
      Texts_WriteText(Tree_f, W_16->TreeCodes->U_1.V_12.Codes.Close);
      Node = W_16->Modules;
      while (Node->U_1.V_1.Kind == Tree_Module) {
  ...
  if (t->U_1.V_1.Kind == Tree_Class) {
    {
      ...
      if ((Tree_NoCodeClass & W_25->Properties) == 0X0L && IN(Tree_HasAttributes, W_25->Properties)) {
        IO_WriteS(Tree_f, (STRING)"case k", 6L);
        Tree_WI(W_25->Name);
        IO_WriteS(Tree_f, (STRING)":", 1L);
        IO_WriteNl(Tree_f);
  ...
  if (t->U_1.V_1.Kind == Tree_Attribute) {
    {
      ...
      if ((Tree_NoCodeAttr & W_26->Properties) == 0X0L) {
        IO_WriteS(Tree_f, (STRING)"close", 5L);
        Tree_WI(W_26->Type);
        IO_WriteS(Tree_f, (STRING)" (yyt->", 7L);
        Tree_WI(iClassName);
  ...
  if (t->U_1.V_1.Kind == Tree_Class) {
    {
      ...
      if ((Tree_NoCodeClass & W_29->Properties) == 0X0L && IN(Tree_HasChildren, W_29->Properties)) {
        IO_WriteS(Tree_f, (STRING)"case k", 6L);
        Tree_WI(W_29->Name);
        IO_WriteS(Tree_f, (STRING)":", 1L);
        IO_WriteNl(Tree_f);
  ...
  if (t->U_1.V_1.Kind == Tree_Child) {
    {
      ...
      if (IN(Tree_Reverse, W_34->Properties)) {
        IO_WriteS(Tree_f, (STRING)"case k", 6L);
        Tree_WI(iClassName);
  ...
  if (t->U_1.V_1.Kind == Tree_Attribute) {
    {
      ...
      if ((Tree_NoCodeAttr & W_37->Properties) == 0X0L) {
        IO_WriteS(Tree_f, (STRING)"copy", 4L);
        Tree_WI(W_37->Type);
        IO_WriteS(Tree_f, (STRING)" ((* yyNew)->", 13L);
        Tree_WI(iClassName);
...
# endif
{
  ...
  if (t->U_1.V_1.Kind == Tree_Class) {
    {
      ...
      if ((Tree_NoCodeClass & W_38->Properties) == 0X0L && IN(Tree_HasChildren, W_38->Properties)) {
        IO_WriteS(Tree_f, (STRING)"case k", 6L);
        Tree_WI(W_38->Name);
        IO_WriteS(Tree_f, (STRING)":", 1L);
        IO_WriteNl(Tree_f);
        iClassName = W_38->Name;
  ...
  if (t->U_1.V_1.Kind == Tree_Child) {
    {
      register Tree_yChild *W_39 = &t->U_1.V_9.Child;
  ...
  if (t->U_1.V_1.Kind == Tree_Class) {
    {
      ...
      if ((Tree_NoCodeClass & W_40->Properties) == 0X0L) {
        iRange = W_40->Name;
        Tree_ForallClasses(W_40->Extensions, (Tree_ProcOfT)InitTypeRange2);
...
# endif
{
  ...
  if (t->U_1.V_1.Kind == Tree_Child) {
    for (;;) {
      {
        register Tree_yChild *W_52 = &t->U_1.V_9.Child;
  ...
  if (t->U_1.V_1.Kind == Tree_Attribute) {
    for (;;) {
      {
        register Tree_yAttribute *W_53 = &t->U_1.V_10.Attribute;
