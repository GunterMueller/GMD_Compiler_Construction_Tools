  ...
  if (t->U_1.V_1.Kind == Tree_Ag) {
    {
      ...
      IO_WriteNl(Tree_f);
      IO_WriteS(Tree_f, (STRING)"# define yyNoLabel	0375", 23L);
      IO_WriteNl(Tree_f);
      IO_WriteS(Tree_f, (STRING)"# define yyLabelDef	0376", 24L);
      IO_WriteNl(Tree_f);
      IO_WriteS(Tree_f, (STRING)"# define yyLabelUse	0377", 24L);
      IO_WriteNl(Tree_f);
      IO_WriteNl(Tree_f);
      ...
      if (Sets_IsElement(ORD('g'), &Tree_Options)) {
        ...
        IO_WriteNl(Tree_f);
        IO_WriteS(Tree_f, (STRING)"  case yyNil		: * yyt = ", 24L);
        Tree_WI(Tree_iNoTree);
        IO_WriteS(Tree_f, (STRING)"; return;", 9L);
        IO_WriteNl(Tree_f);
        IO_WriteS(Tree_f, (STRING)"  case yyLabelUse	: yyGet ((char *) & yyLabel, sizeof (yyLabel));", 65L);
        IO_WriteNl(Tree_f);
        IO_WriteS(Tree_f, (STRING)"   * yyt = yyMapToTree (yyLabel); return;", 41L);
        IO_WriteNl(Tree_f);
        IO_WriteS(Tree_f, (STRING)"  case yyLabelDef	: yyGet ((char *) & yyLabel, sizeof (yyLabel));", 65L);
        IO_WriteNl(Tree_f);
        if (Tree_ClassCount > 251) {
        ...
        IO_WriteNl(Tree_f);
        if (Tree_ClassCount > 251) {
          IO_WriteS(Tree_f, (STRING)"  case yyNoLabel	: yyGet ((char *) & yyKind, sizeof (yyKind));", 62L);
          IO_WriteNl(Tree_f);
          IO_WriteS(Tree_f, (STRING)"   * yyt = Make", 15L);
          Tree_WI(Tree_iMain);
        ...
        IO_WriteS(Tree_f, (STRING)"  default	: * yyt = Make", 24L);
        Tree_WI(Tree_iMain);
        IO_WriteS(Tree_f, (STRING)" (yyKind);", 10L);
        IO_WriteNl(Tree_f);
        IO_WriteS(Tree_f, (STRING)"  }", 3L);
  ...
  if (t->U_1.V_1.Kind == Tree_Class) {
    {
      ...
      if ((Tree_NoCodeClass & W_3->Properties) == 0X0L && ((SET_ELEM(Tree_HasChildren) | SET_ELEM(Tree_HasAttributes)) & W_3->Properties) != 0X0L) {
        IO_WriteS(Tree_f, (STRING)"static void yWriteNode", 22L);
        Tree_WI(W_3->Name);
        IO_WriteNl(Tree_f);
        IO_WriteS(Tree_f, (STRING)"# if defined __STDC__ | defined __cplusplus", 43L);
        IO_WriteNl(Tree_f);
