...
# endif
{
  ...
  case Errors_TooManyErrors:;
    ...
    break;
  case AssignmentWithIncorrectLeftHandSide:;
    IO_WriteS((System_tFile)IO_StdError, (STRING)"assignment with incorrect left hand side", 40L);
    break;
  case CopyRuleWithIncorrectLeftHandSide:;
    IO_WriteS((System_tFile)IO_StdError, (STRING)"copy rule with incorrect left hand side", 39L);
    break;
  case BlockWithIncorrectLeftHandSide:;
    IO_WriteS((System_tFile)IO_StdError, (STRING)"block with incorrect left hand side", 35L);
    break;
  ...
  case NodeTypeNotDeclared:;
    ...
    break;
  case OnlyOneReverseInNodeType:;
    IO_WriteS((System_tFile)IO_StdError, (STRING)"only one reverse in node type", 29L);
    break;
  ...
  case AttributeNeverUsed:;
    ...
    break;
  case InputAttributeIsSet:;
    IO_WriteS((System_tFile)IO_StdError, (STRING)"input attribute is set", 22L);
    break;
  ...
  case NodeTypeNotUsed:;
    ...
    break;
  case InheritedAttributesOnlyInBaseClasses:;
    IO_WriteS((System_tFile)IO_StdError, (STRING)"inherited attributes only in base classes", 41L);
    break;
