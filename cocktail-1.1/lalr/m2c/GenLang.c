...
# endif
{
  if (WriteTok_Language == WriteTok_Modula2) {
    IO_WriteS(f, (STRING)"   yyFirstTerminal		= ", 22L);
    IO_WriteI(f, (LONGINT)Gen_FirstTerminal, 0L);
    IO_WriteC(f, ';');
    IO_WriteNl(f);
    IO_WriteS(f, (STRING)"   yyLastTerminal		= ", 21L);
    IO_WriteI(f, (LONGINT)Gen_LastTerminal, 0L);
    IO_WriteC(f, ';');
    IO_WriteNl(f);
    IO_WriteS(f, (STRING)"   yyFirstSymbol		= ", 20L);
    IO_WriteI(f, (LONGINT)Gen_FirstSymbol, 0L);
    IO_WriteC(f, ';');
    IO_WriteNl(f);
    IO_WriteS(f, (STRING)"   yyLastSymbol		= ", 19L);
    IO_WriteI(f, (LONGINT)Gen_LastSymbol, 0L);
    IO_WriteC(f, ';');
    IO_WriteNl(f);
    IO_WriteS(f, (STRING)"   yyTableMax		= ", 17L);
    IO_WriteI(f, (LONGINT)Compress_TableSize, 0L);
    IO_WriteC(f, ';');
    IO_WriteNl(f);
    IO_WriteS(f, (STRING)"   yyNTableMax		= ", 18L);
    IO_WriteI(f, (LONGINT)Compress_NTableSize, 0L);
    IO_WriteC(f, ';');
    IO_WriteNl(f);
    IO_WriteS(f, (STRING)"   yyFirstReadState		= ", 23L);
    IO_WriteI(f, (LONGINT)Gen_FirstReadState, 0L);
    IO_WriteC(f, ';');
    IO_WriteNl(f);
    IO_WriteS(f, (STRING)"   yyLastReadState		= ", 22L);
    IO_WriteI(f, (LONGINT)Gen_LastReadState, 0L);
    IO_WriteC(f, ';');
    IO_WriteNl(f);
    IO_WriteS(f, (STRING)"   yyFirstReadTermState		= ", 27L);
    IO_WriteI(f, (LONGINT)Gen_FirstReadTermState, 0L);
    IO_WriteC(f, ';');
    IO_WriteNl(f);
    IO_WriteS(f, (STRING)"   yyLastReadTermState		= ", 26L);
    IO_WriteI(f, (LONGINT)Gen_LastReadTermState, 0L);
    IO_WriteC(f, ';');
    IO_WriteNl(f);
    IO_WriteS(f, (STRING)"   yyLastReadNontermState		= ", 29L);
    IO_WriteI(f, (LONGINT)Gen_LastReadNonTermState, 0L);
    IO_WriteC(f, ';');
    IO_WriteNl(f);
    IO_WriteS(f, (STRING)"   yyFirstReduceState		= ", 25L);
    IO_WriteI(f, (LONGINT)Gen_FirstReduceState, 0L);
    IO_WriteC(f, ';');
    IO_WriteNl(f);
    IO_WriteS(f, (STRING)"   yyLastReduceState		= ", 24L);
    IO_WriteI(f, (LONGINT)Gen_LastReduceState, 0L);
    IO_WriteC(f, ';');
    IO_WriteNl(f);
    IO_WriteS(f, (STRING)"   yyStartState		= ", 19L);
    IO_WriteI(f, (LONGINT)Gen_StartState(), 0L);
    IO_WriteC(f, ';');
    IO_WriteNl(f);
    IO_WriteS(f, (STRING)"   yyStopState		= ", 18L);
    IO_WriteI(f, (LONGINT)Gen_StopState, 0L);
    IO_WriteC(f, ';');
    IO_WriteNl(f);
  } else {
    IO_WriteS(f, (STRING)"# define yyFirstTerminal	", 25L);
    IO_WriteI(f, (LONGINT)Gen_FirstTerminal, 0L);
    IO_WriteNl(f);
    IO_WriteS(f, (STRING)"# define yyLastTerminal		", 25L);
    IO_WriteI(f, (LONGINT)Gen_LastTerminal, 0L);
    IO_WriteNl(f);
    IO_WriteS(f, (STRING)"# define yyTableMax		", 21L);
    IO_WriteI(f, (LONGINT)Compress_TableSize, 0L);
    IO_WriteNl(f);
    IO_WriteS(f, (STRING)"# define yyNTableMax		", 22L);
    IO_WriteI(f, (LONGINT)Compress_NTableSize, 0L);
    IO_WriteNl(f);
    IO_WriteS(f, (STRING)"# define yyFirstReadState	", 26L);
    IO_WriteI(f, (LONGINT)Gen_FirstReadState, 0L);
    IO_WriteNl(f);
    IO_WriteS(f, (STRING)"# define yyLastReadState	", 25L);
    IO_WriteI(f, (LONGINT)Gen_LastReadState, 0L);
    IO_WriteNl(f);
    IO_WriteS(f, (STRING)"# define yyFirstReadTermState	", 30L);
    IO_WriteI(f, (LONGINT)Gen_FirstReadTermState, 0L);
    IO_WriteNl(f);
    IO_WriteS(f, (STRING)"# define yyLastReadTermState	", 29L);
    IO_WriteI(f, (LONGINT)Gen_LastReadTermState, 0L);
    IO_WriteNl(f);
    IO_WriteS(f, (STRING)"# define yyLastReadNontermState	", 32L);
    IO_WriteI(f, (LONGINT)Gen_LastReadNonTermState, 0L);
    IO_WriteNl(f);
    IO_WriteS(f, (STRING)"# define yyFirstReduceState	", 28L);
    IO_WriteI(f, (LONGINT)Gen_FirstReduceState, 0L);
    IO_WriteNl(f);
    IO_WriteS(f, (STRING)"# define yyLastReduceState	", 27L);
    IO_WriteI(f, (LONGINT)Gen_LastReduceState, 0L);
    IO_WriteNl(f);
    IO_WriteS(f, (STRING)"# define yyStartState		", 23L);
    IO_WriteI(f, (LONGINT)Gen_StartState(), 0L);
    IO_WriteNl(f);
    IO_WriteS(f, (STRING)"# define yyStopState		", 22L);
    IO_WriteI(f, (LONGINT)Gen_StopState, 0L);
    IO_WriteNl(f);
  }
}
    ...
    prod = (Automaton_tProduction)ADR(Automaton_ProdArrayPtr->A[index]);
    {
      ...
      if (index == 0) {
        ...
        if (WriteTok_Language == WriteTok_Modula2) {
          ...
          IO_WriteS(f, (STRING)"); yyNonterminal := ", 20L);
