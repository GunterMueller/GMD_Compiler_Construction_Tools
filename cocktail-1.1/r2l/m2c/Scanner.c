...
#define yyDStateCount	159
#define yyTableSize	2029
    ...
    for (;;) {
      ...
      for (;;) {
        ...
        case 149:;
          ...
          break;
        case 148:;
          Errors_ErrorMessage((LONGCARD)UnclosedString, (LONGCARD)Error, Scanner_Attribute.Position);
          Strings_Append(&String, Strings_Char(&String, 1));
          yyEol(0L);
          yyPrevious();
          Strings_Concatenate(&TargetCode, &String);
          ...
          if (yyChBufferIndex != yyChBufferStart + yyBytesRead) {
            ...
            if (Scanner_TokenLength == 0) {
              ...
              if (yyFileStackPtr == 0) {
                ...
                case targetcode:;
                case set:;
                  Errors_ErrorMessage((LONGCARD)BraceMissing, (LONGCARD)Error, Scanner_Attribute.Position);
                  break;
                case comment:;
                  Errors_ErrorMessage((LONGCARD)UnclosedComment, (LONGCARD)Error, Scanner_Attribute.Position);
                  break;
                case CStr1:;
                case CStr2:;
                case Str1:;
